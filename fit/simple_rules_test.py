...
for num_in_train in num_in_train_list:
    ...
    for noise in noise_levels:
        ...
        class_rules = ((LABEL.vocab.stoi['0'],TEXT.vocab.stoi['b']),(LABEL.vocab.stoi['1'], TEXT.vocab.stoi['a']))
        print(class_rules)
            ...
            for i in range(repeats):
                ...
                for epoch in range(num_epochs):
                    ...
                    for batch_idx, batch in enumerate(train_iter):
                        ...
                        stop =  np.random.randint(batch_length-start)
