...
answers = data.Field(sequential=False, unk_token=None,use_vocab  = True)
segment1_label = data.Field(sequential=False, unk_token=None, dtype=torch.float16,use_vocab  = False)
segment2_label = data.Field(sequential=False, unk_token=None, dtype=torch.float16,use_vocab  = False)
stop_pos = data.Field(sequential=False, unk_token=None,use_vocab  = False)
